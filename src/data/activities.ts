...
export const MOCK_SCHEDULE: Activity[] = [
  ...
  },
  {
    ...
    points: 1,
    duration: '60 min',
    image: '/assets/Adidas_Fitstreet.png',
  ...
  },
  {
    ...
    points: 10,
    duration: '5.5 hours',
    image: '/assets/G\'League_Fitstreet.png',
...
export const B2B_PASSPORT_BRANDS: PassportBrand[] = [
  ...
  },
  {
    ...
    qrSecret: 'SK-2026-PB',
    geofenceRadius: '20m',
    logo: '/assets/Skippy_Fitstreet.png', 
    isCompleted: false,
    zone: 'EAT',
  ...
  },
  {
    ...
    geofenceRadius: '20m',
    logo: '/assets/Goodies_Fitstreet.png', 
    isCompleted: false,
    zone: 'PLAY',
  ...
  },
  {
    ...
    qrSecret: 'AD-2026-XP',
    geofenceRadius: '20m',
    logo: '/assets/Adidas_Fitstreet.png',
    isCompleted: false,
    zone: 'PLAY',
